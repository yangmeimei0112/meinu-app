        ...
        {stores.map((store) => {
          ...
          return (
            <Link
              ...
              className={`bg-white dark:bg-[#131B2B] rounded-2xl p-3 border shadow-2xs transition flex flex-col items-center text-center gap-2 group active:scale-95 cursor-pointer relative overflow-hidden ${
                isAccepting
            ...
            >
              {!isAccepting && (
                <span className="absolute top-1 right-1 text-[8px] font-bold text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-950 px-1 rounded-full border border-amber-200/60">
                  暫停
                </span>
              )}
