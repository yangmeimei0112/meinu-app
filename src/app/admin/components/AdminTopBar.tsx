...
export default function AdminTopBar({
  ...
  return (
    <header data-theme-module="header" className="bg-white/90 dark:bg-[#070B14]/90 backdrop-blur-xl border-b border-slate-200/90 dark:border-slate-800/80 sticky top-0 z-40 px-3 sm:px-4 py-2.5 sm:py-3 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.03)] select-none transition-colors duration-200">
