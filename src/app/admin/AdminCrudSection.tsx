            ...
            <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-xl text-xs font-bold shrink-0 border border-transparent dark:border-slate-700">
              <button
                ...
                className={`px-3 py-1 rounded-lg transition cursor-pointer ${
                  itemStatusFilter === 'all' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100 shadow-xs' : 'text-slate-500 dark:text-slate-400'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1 rounded-lg transition cursor-pointer ${
                  itemStatusFilter === 'active' ? 'bg-white dark:bg-slate-700 text-emerald-700 dark:text-emerald-300 shadow-xs' : 'text-slate-500 dark:text-slate-400'
                }`}
              >
                🟢 上架中 ({activeItemCount})
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-lg transition cursor-pointer ${
                  itemStatusFilter === 'sold_out' ? 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 shadow-xs' : 'text-slate-500 dark:text-slate-400'
                }`}
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      <h4 className="font-black text-slate-800 dark:text-slate-100 text-base truncate">
                        {item.name}
                      </h4>
                      <p className="text-sky-600 dark:text-sky-400 font-black text-sm mt-0.5">
                        ${item.price} <span className="text-[10px] text-slate-400 dark:text-slate-400 font-normal">元</span>
                      </p>
                    </div>
            ...
            <div className="flex bg-slate-200/70 dark:bg-slate-800/80 p-1 rounded-xl text-xs font-bold text-slate-600 dark:text-slate-300 max-w-sm border border-transparent dark:border-slate-700">
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg transition cursor-pointer ${
                  globalSettingTab === 'categories' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100 shadow-xs' : ''
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg transition cursor-pointer ${
                  globalSettingTab === 'payments' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100 shadow-xs' : ''
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-1.5 rounded-lg transition cursor-pointer ${
                  globalSettingTab === 'sold_outs' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-slate-100 shadow-xs' : ''
                }`}
              >
            ...
            {globalSettingTab === 'categories' && (
              <div className="space-y-2">
                ...
                <div className="space-y-1.5 max-h-[220px] overflow-y-auto pr-1">
                  {categories.map((cat) => (
                    <div key={cat.id} className="bg-white dark:bg-[#131B2B] p-2 rounded-xl border border-slate-200 dark:border-slate-700 flex items-center gap-2">
                      <input
                        id={`cat-item-${cat.id}`}
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2 max-h-[220px] overflow-y-auto pr-1">
                  {paymentMethods.map((method) => (
                    <div key={method.id} className="bg-white dark:bg-[#131B2B] p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 space-y-1.5">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5 max-h-[220px] overflow-y-auto pr-1">
                  {soldOutOptions.map((opt) => (
                    <div key={opt.id} className="bg-white dark:bg-[#131B2B] p-2 rounded-xl border border-slate-200 dark:border-slate-700 flex items-center gap-2">
                      <input
