...
export const CHANGELOG_RELEASES: ChangelogRelease[] = [
  {
    ...
    highlights: [
      '🥤 中杯 / 大杯個別定價：後台商品視窗提供一鍵啟用開關，直接輸入中杯、大杯等各尺寸最終售價，系統自動精確換算價差',
      '➕ 任意尺寸無限擴充：預設內建特大杯 (XL)、分享瓶 (Bottle)、小杯 (S)、小份/大份快捷按鈕，支援任意自訂尺寸名稱與獨立價格',
      '🏷️ 前台菜單動態起價標示：含多尺寸商品自動展示「$50 起」與「中/大杯」標籤，大幅提升消費者選購體驗',
      '⚡ 客製化點餐即時單價連動：點餐彈窗動態標註各尺寸最終單價，並連動頂部即時單價與底部總金額即時計算',
      '🧪 184 / 184 項 E2E 測試 100% 通過：完整涵蓋中大杯差價換算、負差價防護、零值防呆、自訂多尺寸擴充與邊界測試',
    ],
    items: [
      {
        type: 'feature',
        title: '後台商品編輯新增「尺寸與個別定價構建器 (ProductSizePricingBuilder)」',
        description:
          '店家管理者在新增或編輯商品時，可一鍵開啟多尺寸定價，直接輸入各尺寸售價，系統自動同步轉換為規格群組 JSONB，無縫向下相容舊資料。',
        badgeText: '後台管理',
      },
      {
        type: 'feature',
        title: '常用規格範本庫擴充「手搖飲容量尺寸」與「餐點份量大小」',
        description:
          '客製規格範本庫新增中杯/大杯/特大杯/瓶裝與小份/中份/大份常用規格，支援店家一鍵套用。',
        badgeText: '規格範本',
      },
      {
        type: 'enhancement',
        title: '前台菜單卡片與點餐彈窗視覺與動態計算優化',
        description:
          '菜單卡片標示容量徽章與起價；點餐彈窗即時計算已選尺寸之完整單價，避免顧客心算困擾。',
        badgeText: '顧客體驗',
      },
    ],
  },
